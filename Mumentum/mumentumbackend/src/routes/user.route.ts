...
router.route("/undo-delete-user").delete(authMiddleware,undoDeleteUser)
...
router.route("/link-github").get(authMiddleware,linkGithub)
router.route("/unlink-github").patch(authMiddleware,unlinkGithub)
